      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/rabbitmq"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("rabbitmq") &&
                    "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
              ...
              <li>
                <Link
                  href="/proxy"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("proxy") &&
                    "bg-graydark dark:bg-meta-4"
                    }`}
                >
              ...
              <li>
                <Link
                  href="/database"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("database") &&
                    "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
		...
		C4,6.05,13.445,2,27,2z"/>
              ...
              <li>
                <Link
                  href="/logs"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("logs") &&
                    "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
